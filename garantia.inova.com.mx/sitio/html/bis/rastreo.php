...
<?php
	if($va['Status'] == 'Shipped' ){
		...
		$url_tracking['usps'] = '<a href="https://tools.usps.com/go/TrackConfirmAction_input?origTrackNum=#GUIA#" target="blank">';
		...
		while( $shipments = mysql_fetch_assoc($result_shp ) ) {
			...
			if($shipments['shpprovider'] =='estafeta' || $shipments['shpprovider'] =='fedex' || $shipments['shpprovider'] == 'ups' || $shipments['shpprovider'] == 'usps'){
...
<center>
	<div style="border: 1px solid #fbca6b; padding: 15px; background-color:#fdfdb3;margin-top:5px;width:90%;max-width:340px;">
		...
		<font size=4><b>Tel. 1-888-339-2990</b></font>
	</div>
	<br><br>
<center>
