<?php
	...
	$site_domain    					= "hc.bodycrunch.com.mx";
	$site_track    						= "www.hc.bodycrunch.com.mx";
	...
	#$url_paymentgateway					= "http://hc.direksys2.com/payworks/banorte_paymentsgwmx.php";
	#$url_paymentgateway					= "http://hc.direksys2.com/payworks/banorte_paymentsgwmx.v2.php";
	$url_paymentgateway					= "http://hc.direksys2.com/payworks/globalcollect_paymentsgwmx.php";
	$tmp_data 							= "/home/www/domains/dev.hceja/webs_mx//httpdocs";
	$path_templates						= "/home/www/domains/dev.hceja/webs_mx/bodycrunch.com.mx/cgi-bin/templates2/";
	$path_shoppingcart					= "/home/www/domains/dev.hceja/webs_mx/bodycrunch.com.mx/cgi-bin/shoppingcart/";
	$path_shoppingcart2					= "/home/www/domains/dev.hceja/webs_mx/bodycrunch.com.mx/cgi-bin/shoppingcart2/";
	$path_objects						= 	$path_templates . "objects/";
	$orderfiles							= '/home/www/domains/dev.hceja/webs_mx/bodycrunch.com.mx/orders';
	$salesemail							= "sales@innovagroupusa.com";

	#$data['contact_phone'] 			= "1-888-339-2990";
	#$data['contact_mail']				="contacto@dermawand.com.mx";

	#$data['gmail_username'] 			= "no-responder@bodycrunch.com.mx";//no-responder@eagleeyes.com.mx
...
$overlay_order_img=array('b_edit.png','b_edit.png');
	...
	$products_belongsto = 'bodycrunchtv';
