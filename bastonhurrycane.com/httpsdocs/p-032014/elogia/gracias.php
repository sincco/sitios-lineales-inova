...
$true = $_GET["ist"];
if($true){
$form_id = rand(99999999999, 9999999999999);
}else{$form_id = '';}
?>
<body style="background:url(../general/images/background.jpg) top center no-repeat;">
<img src="https://tbl.tradedoubler.com/report?organization=1905613&event=307404&leadNumber=<?php echo $form_id ?>" border=0>
...
<div class="page_main_wrapper" style="background:none"><div class="px1000">
...
<div class="col_set tnkyou_page">
	...
	<div class="col_1_2">
        ...
        <ul class="buy_now_list">
        	<li class="buy_online"><a href="https://www.inova.com.mx/1038-Hurrycane.aspx" class="button_style_1">COMPRA EN LÍNEA</a></li>
        	<li>
            	<a style="width:100%;margin-left:10%;" href="tel:0180012106485">
            	<img src="https://bastonhurrycane.com/p-032014/general/images/phone_icon.png" />
                <span>01800 1210 6485</span>
                </a>
            </li>
            <li>
            	...
            	<img src="https://bastonhurrycane.com/p-032014/general/images/chat_icon.png" />
            	<span>Por chat</span>
                </a>
            </li>
        </ul>
