<?php
	...
	$site_domain    					= "hc.bastonhurrycane.com";
	$site_track    						= "www.hc.bastonhurrycane.com";
	$site_checkout						= "http://".$site_domain ."/comprar.php?paso=1";
	$contacts_min						= 0;
	...
	$tmp_data 							= "/home/www/domains/dev.hceja/webs_mx/bastonhurrycane.com/httpdocs";
	$path_templates						= "/home/www/domains/dev.hceja/webs_mx/bastonhurrycane.com/cgi-bin/templates2/";
	$path_shoppingcart					= "/home/www/domains/dev.hceja/webs_mx/bastonhurrycane.com/cgi-bin/shoppingcart/";
	$path_shoppingcart2					= "/home/www/domains/dev.hceja/webs_mx/bastonhurrycane.com/cgi-bin/shoppingcart2/";
	$path_objects						= 	$path_templates . "objects/";
	$orderfiles							= '/home/www/domains/dev.hceja/webs_mx/bastonhurrycane.com/orders';
	$salesemail							= "sales@innovagroupusa.com";

	#$data['contact_phone'] 			= "1-888-339-2990";
	#$data['contact_mail']				="contacto@dermawand.com.mx";

	#$data['gmail_username'] 			= "no-responder@bastonhurrycane.com";//no-responder@eagleeyes.com.mx
...
$overlay_order_img=array('b_edit.png','b_edit.png');
	...
	$products_belongsto = 'bastonhurrycane';
